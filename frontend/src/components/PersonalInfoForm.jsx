...
const PersonalInfoForm = ({
  ...
  return (
    <div>
      <h3 className="text-lg font-semi-bold text-gray-900">
        Personal Information
      </h3>
      <p className="text-gray-600">Get started with personal Information</p>
      <div className="flex items-center gap-2">
        <label>
          {data.image ? (
            ...
            cursor-pointer text-slate-600 hover:text-slate-700"
            >
        ...
        {typeof data.image === "object" && (
          <div className="flex flex-col gap-1 pl-4 text-sm">
            ...
            <label className="relative text-gray-900 inline-flex items-center cursor-pointer gap-3">
              <input
                type="checkbox"
              ...
              peer-checked:bg-green-600 transition-colors duration-300"
              ></div>
              <span
      ...
      {fields.map((field) => {
        ...
        return (
          <div key={field.key} className="space-y-1 mt-5">
            ...
            className="mt-1 w-full px-2 py-2 border-gray-300 rounded-lg
